  ...
  return (
    ...
    <div className='relative'>
      ...
      <Image src='/hero-pattern.png' alt='Hero' width={1440} height={1440}   className='absolute top-0 left-0 z-[1] max-sm:h-[80vh] max-md:h-[100vh] w-full'/>
        <div className='relative z-[2] max-md:max-w-[518px] max-w-[566px] w-full text-center  flex flex-col items-center max-sm:gap-6 gap-8'>
          ...
          <p className='font-roboto-flex  max-md:text-base opacity-70 max-w-lg font-normal'>{'Our platform allows you to trade and invest your funds with ease. Your funds will remain in your account, and our platform connects to it securely through our API. We trade your funds in the spot market, generating income without the need for liquidation.'}</p>
